...
export async function startServer(command: string, envs: Record<string, string>, id: string, e2bApiKey: string) {
...
export async function extendOrRestartServer(serverId: string, e2bApiKey: string): Promise<boolean> {
